<!DOCTYPE html>
<?php  
	//include starts from current folder
			...
			<div id="inputContainer">
					<form id="loginForm" action="register.php" method="POST">
						...
						<p>
							...
							<input id="loginUsername" name="loginUsername" type="text" placeholder="e.g. John Doe" value="<?php getInputValue('loginUsername') ?>"  required>
						</p>
						<p>
					...
					<form id="registerForm" action="register.php" method="POST">
						...
						<p>
							...
							<input id="email" name="email" type="email" placeholder="e.g. JohnDoe@xyz.com" value="<?php getInputValue('email') ?>" required>
						</p>

						<p>
							<label for="email2">Confirm Email</label>
							<input id="email2" name="email2" type="email" placeholder="e.g. JohnDoe@xyz.com" value="<?php getInputValue('email2') ?>" required>
						</p>

						<p>
							<?php echo $account->getError( Constants::$passwordsDoNotMatch); ?>
							<?php echo $account->getError( Constants::$passwordsNotAlphanumeric); ?>
							<?php echo $account->getError(Constants::$passwordsCharachters); ?>
